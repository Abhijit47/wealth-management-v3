...
image: 'https://newapps.anchoredge.in/branding/Content/Blogimage/thumb/1696657260mutualfund-01.png'
slug: 'explore-the-world-of-mutual-fund-categories-a-deep-dive-into-large-mid-and-small-cap-funds'
summary: 'Discover the differences between large-cap, mid-cap, and small-cap mutual funds. Learn how to choose the right fund based on your investment goals and risk tolerance.'
...
- **Market Cap (Capitalization):** This refers to the total value of a company based on the number of its shares in the stock market based on current market price.
- **Large Cap:** The top 100 stocks based on market capitalization are categorised as large cap stocks.
- **Mid Cap:** Stocks that are ranked from 101 to 250 in terms
  of market capitalization are categorised as mid-cap stocks.
- **Small Cap:** The companies ranked from the 251st position onwards in terms of market capitalization are categorised as small-cap stocks.
