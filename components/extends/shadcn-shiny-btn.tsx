...
interface ShadCNShinyButtonProps
...
export const ShadCNShinyButton = React.forwardRef<
  HTMLButtonElement,
  ShadCNShinyButtonProps
    ...
    <motion.button
      ...
      className={cn(
        buttonVariants({
          variant: 'default',
          className:
            'relative overflow-hidden rounded-lg px-6 py-2 font-medium! backdrop-blur-xl! transition-shadow duration-300 ease-in-out hover:shadow-lg!',
        }),
        className
      )}
      {...animationProps}
...
ShadCNShinyButton.displayName = 'ShadCNShinyButton';
