...
const Blockquote = ({ children, className }: BlockquoteProps) => {
  return (
    <div
      className={cn(
        "relative rounded-lg border-l-8 border-l-primary-700 bg-primary-500 py-5 pr-5 font-sans italic leading-relaxed text-primary-500 before:absolute before:left-3 before:top-3 before:font-serif before:text-primary-700 before:content-['“']",
        className,
